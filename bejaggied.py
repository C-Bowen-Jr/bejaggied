...
class GameBoard:
    def __init__(self):
        ...
        for y in range(0, SPACE_SIZE*(NUM_OF_ROWS+1), SPACE_SIZE):
            pygame.draw.line(self.grid, GRID_COLOR, (0,y), (SPACE_SIZE*NUM_OF_COLUMNS, y))
    ...
    def draw(self):
        self.screen.blit(self.background, pygame.Rect(0,0,800,600))
...
class Cell:
    def __init__(self, image, pos):
        self.images = [pygame.image.load(os.path.join("images",'blue-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'green-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'orange-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'purple-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'red-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'white-1.png')).convert_alpha(),
                     pygame.image.load(os.path.join("images",'yellow-1.png')).convert_alpha()]
        
        #special_images should be of same length as images
        self.special_images = [pygame.image.load(os.path.join("images",'blue-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'green-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'orange-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'purple-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'red-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'white-2.png')).convert_alpha(),
                             pygame.image.load(os.path.join("images",'yellow-2.png')).convert_alpha()]
